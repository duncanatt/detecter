...
You should try expressing the safety properties P~1~, P~2~, and P~3~ stated informally in the [Getting Started](using-detecter/getting-started.md) section in terms of maxHML.
